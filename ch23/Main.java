...
public class Main {
	...
	private static AdminSearchUsers adminSearchUsers;
	private static AdminUpdateDeleteUsers adminUpdateDeleteUsers;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					adminSearchUsers = new AdminSearchUsers();
					adminSearchUsers.setVisible(false);
	...
	public static AdminSearchUsers getAdminSearchUsers() {
		return adminSearchUsers;
	}
	
	public static AdminUpdateDeleteUsers getAdminUpdateDeleteUsers() {
		return adminUpdateDeleteUsers;
	}
